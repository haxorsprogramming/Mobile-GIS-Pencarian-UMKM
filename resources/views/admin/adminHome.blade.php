...
<body>
    ...
    <ul id="menu-mobile" class="side-nav">
      <li>
        <div class="user-view">
          ...
          <a href="javascript:void(0)"><span class="white-text name">Selamat datang Administrator</span></a>
  ...
  <script type="text/javascript" src="{{ asset('') }}ladun/js/beranda-admin.js"></script>
</body>
